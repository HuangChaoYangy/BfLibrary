...
class CommonFunc(object):
    ...
    def get_environment_config(self, environment="extranet"):
        '''
        获取数据库环境配置
        :param environment:
        :return:
        ...
        # print(configure[0]['environment'])
        environment_dic = {"mde": "mde", "120": "120", "extranet": "extranet" }
        mysql_info = []
        mongo_info = []
        ...
        elif configure[0]['environment'] == environment_dic[environment]:
...
if __name__ == "__main__":
    ...
    mysql_info,mongo_info = cf.get_environment_config(environment="extranet")
