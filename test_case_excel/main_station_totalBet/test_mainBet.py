                    ...
                    for sport in APIResult_list:
                        for matchInfo in sport['agentBetTournamentVOS']:
                            for market in matchInfo['agentBetStatisticsVO']:
                                ...
                                actualResult.append([sport['sportName'], market['matchStartTime'], matchInfo['tournamentName'] + ' ' + market['homeTeamName'] + ' vs ' + market['awayTeamName'],
                                                     full_market['ahHome'], full_market['ahAway'],
